    ...
    return (
        ...
        <div  className="row py-5">
           <div className="col-sm-12 col-md-6 col-lg-3  text-center text-lg-start">
               <h2 className="fw-bold text-warning">Ema John</h2>
           ...
           <h4>CONTACT US</h4>
            <p className="lh-lg fw-light">No: 58 A, East Mirpur Street,<br/>Alaska, MD,<br/>USA 4508.<br/><i class="fas fa-phone-alt"></i> +880-1234567891 <br /> <i class="far fa-envelope"></i>  support@somemail.com</p>
            </div> 
